              ...
              <div className="mt-6 space-y-4">
                    ...
                    <div className="mt-2">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <div className="flex gap-1">
                          ...
                          <div className={`h-1 w-8 rounded ${passwordStrength === 'medium' ? 'bg-yellow-500' : passwordStrength === 'strong' ? 'bg-green-500' : 'bg-gray-300'}`} />
                          <div className={`h-1 w-8 rounded ${passwordStrength === 'strong' ? 'bg-green-500' : 'bg-gray-300'}`} />
                        </div>
                    ...
                    <div className="relative mt-1">
                      <input
                        ...
                        className={`block w-full px-3 py-2 pr-10 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm disabled:bg-gray-100 dark:disabled:bg-gray-800 ${
                          passwordMismatch && confirmPassword ? 'border-red-300 dark:border-red-600' : 'border-gray-300 dark:border-gray-600'
                        }`}
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    disabled={uploading || (!!password && (passwordErrors.length > 0 || passwordMismatch || !confirmPassword))}
